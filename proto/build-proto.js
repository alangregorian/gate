...
const serviceNameMap = {
	account: "mux.AccountService",
	browser: "mux.BrowserService",
	checkpoints: "mux.CheckpointsService",
	file: "mux.FileService",
	mcp: "mux.McpService",
	state: "mux.StateService",
	task: "mux.TaskService",
	web: "mux.WebService",
	models: "mux.ModelsService",
	slash: "mux.SlashService",
...
async function ensureProtoFilesExist() {
	...
	for (const [serviceName, fullServiceName] of Object.entries(serviceNameMap)) {
		if (!existingProtoServices.includes(serviceName)) {
			...
			// Extract service class name from full name (e.g., "mux.ModelsService" -> "ModelsService")
...
package mux;
option java_package = "bot.mux.proto";
