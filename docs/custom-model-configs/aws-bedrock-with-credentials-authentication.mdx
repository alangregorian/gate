---
title: "AWS Bedrock"
description: "Learn how to set up AWS Bedrock with MUX using credentials authentication. This guide covers AWS environment setup, regional access verification, and secure integration with the MUX VS Code extension."
---
...
-   **MUX:** A VS Code extension that acts as a coding assistant by integrating with AI models—empowering developers to generate code, debug, and analyze data.
...
2. **Install the MUX Extension:**
    - Open VS Code.
    - Go to the Extensions Marketplace (`Ctrl+Shift+X` or `Cmd+Shift+X`).
    - Search for **MUX** and install it.
...
By following these steps, your enterprise team can securely integrate AWS Bedrock with the MUX VS Code extension to accelerate development:
...
3. **Configure MUX in VS Code:** Install and set up MUX with your AWS credentials and choose an appropriate model.
...
_This guide will be updated as AWS Bedrock and MUX evolve. Always refer to the latest documentation and internal policies for up-to-date practices._
