---
title: "LiteLLM & MUX (using Codestral)"
description: "Learn how to set up and run LiteLLM with MUX using the Codestral model. This guide covers Docker setup, configuration, and integration with MUX."
---

### Using LiteLLM with MUX

This guide demonstrates how to run a demo for LiteLLM starting with the Codestral model for use with MUX.
...
2. **Setup MUX**
    ...
    Once the LiteLLM server is up and running you can set it up in MUX:
...
-   [MUX Discord Community](https://discord.gg/mux)
