---
title: "Task Management in MUX"
description: "Learn how to effectively manage your task history, use favorites, and organize your work in MUX."
---

# Task Management

As you use MUX, you'll accumulate many tasks over time. The task management system helps you organize, filter, search, and clean up your task history to keep your workspace efficient.

## Accessing Task History

You can access your task history by:

1. Clicking on the "History" button in the MUX sidebar
2. Using the command palette to search for "MUX: Show Task History"
...
-   **Open**: Click on a task to reopen it in the MUX chat
...
Task management helps you maintain an organized workflow when using MUX, allowing you to quickly find past conversations, preserve important work, and keep your history clean and efficient.
