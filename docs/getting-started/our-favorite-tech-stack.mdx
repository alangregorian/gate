...
description: "A curated list of our recommended technologies and tools for building modern web applications with MUX."
---

## Recommended Stack for New MUX Users (2025)
...
1. Install the development essentials:
    - Follow our [Development Essentials Installation Guide](https://docs.mux.bot/getting-started/getting-started-new-coders/installing-dev-essentials)
2. Set up MUX's Memory Bank:
    - Follow the [Memory Bank setup instructions](https://docs.mux.bot/improving-your-prompting-skills/custom-instructions-library/mux-memory-bank)
    - Create an empty `mux_docs` folder in your project root
    - Create `projectBrief.md` in the `mux_docs` folder (see example below)
    - Tell MUX to "initialize memory bank"
3. Add our recommended stack configuration:
    - Create `.muxrules` file (see template below)
    - Let MUX handle the rest!
...
-   Be reviewed by MUX before execution
    Example: 001_create_users_table.sql

## Development Workflow

-   MUX helps write and review code changes
-   Vercel automatically deploys from main branch
-   Database migrations reviewed by MUX before execution
...
1. Use `/help` in MUX chat for immediate assistance
2. Check [MUX Documentation](https://docs.mux.bot)
3. Join our [Discord Community](https://discord.gg/mux)
4. Search GitHub issues for common problems

Remember: MUX is here to help at every step. Just ask for guidance or clarification when needed!
