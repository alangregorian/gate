---
title: "MUX Tools Reference Guide"
---
...
For the most up-to-date implementation details, you can view the full source code in the [MUX repository](https://github.com/mux/mux/blob/main/src/core/MUX.ts).
