...
const log = (...args: unknown[]) => {
	...
	console.log(`[${timestamp}]`, "#bot.mux.server.ts", ...args)
}

// Load service definitions.
const descriptorSet = fs.readFileSync("proto/descriptor_set.pb")
const muxDef = protoLoader.loadFileDescriptorSetFromBuffer(descriptorSet)
const healthDef = protoLoader.loadSync(health.protoPath)
const packageDefinition = { ...muxDef, ...healthDef }
