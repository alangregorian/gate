...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	const [
		...
		getSecret(context, "muxApiKey") as Promise<string | undefined>,
		...
		getGlobalState(context, "globalMUXRulesToggles") as Promise<MUXRulesToggles | undefined>,
...
export async function updateApiConfiguration(context: vscode.ExtensionContext, apiConfiguration: ApiConfiguration) {
	...
	await storeSecret(context, "muxApiKey", muxApiKey)
