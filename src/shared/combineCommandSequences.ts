import { MUXMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of MUXMessages.
 *
 * This function processes an array of MUXMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of MUXMessage objects to process.
 * @returns A new array of MUXMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: MUXMessage[]): MUXMessage[] {
	const combinedCommands: MUXMessage[] = []
