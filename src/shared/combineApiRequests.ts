...
/**
 * Combines API request start and finish messages in an array of MUXMessages.
 *
 ...
 * @returns A new array of MUXMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: MUXMessage[]): MUXMessage[] {
	const combinedApiRequests: MUXMessage[] = []
