...
export async function regexSearchFiles(
	...
	// Filter results using MUXIgnoreController if provided
	const filteredResults = muxIgnoreController
		? results.filter((result) => muxIgnoreController.validateAccess(result.filePath))
		: results
