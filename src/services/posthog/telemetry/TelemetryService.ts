...
/**
 * PostHogClient handles telemetry event tracking for the MUX extension
...
class PostHogClient {
	...
	/**
	 * Records when mux calls the task completion_result tool signifying that mux is done with the task
