...
// Featured models for MUX provider
...
const OpenRouterModelPicker: React.FC<OpenRouterModelPickerProps> = ({ isPopup }) => {
	...
	const modelIds = useMemo(() => {
		...
		return apiConfiguration?.apiProvider === "mux"
	...
	return (
		<div style={{ width: "100%" }}>
			...
			<div style={{ display: "flex", flexDirection: "column" }}>
				...
				{apiConfiguration?.apiProvider === "mux" && (
			...
			{hasInfo ? (
				...
				<p
					...
					<>
						...
						If you're unsure which model to choose, MUX works best with{" "}
						<VSCodeLink
