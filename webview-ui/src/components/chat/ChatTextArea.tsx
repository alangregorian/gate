...
import MUXRulesToggleModal from "../mux-rules/MuxRulesToggleModal"
			...
			<div>
				...
				<ControlsContainer>
					...
					<Tooltip
						...
						tipText={`In ${shownTooltipMode === "act" ? "Act" : "Plan"}  mode, MUX will ${shownTooltipMode === "act" ? "complete the task immediately" : "gather information to architect a plan"}`}
