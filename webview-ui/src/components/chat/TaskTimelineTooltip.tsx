...
const TaskTimelineTooltip = ({ message, children }: TaskTimelineTooltipProps) => {
	const getMessageDescription = (message: MUXMessage): string => {
		if (message.type === "say") {
			switch (message.say) {
	...
	const getMessageContent = (message: MUXMessage): string => {
		if (message.text) {
	...
	const getTimestamp = (message: MUXMessage): string => {
		if (message.ts) {
	...
	const getMessageColor = (message: MUXMessage): string => {
		if (message.type === "say") {
			switch (message.say) {
				case "task":
