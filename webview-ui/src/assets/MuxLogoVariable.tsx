...
/**
 * MUXLogoVariable component renders the MUX logo with automatic theme adaptation.
 *
 ...
 * @returns {JSX.Element} SVG MUX logo that adapts to VS Code themes
 */
const MUXLogoVariable = (props: SVGProps<SVGSVGElement>) => (
...
export default MUXLogoVariable
