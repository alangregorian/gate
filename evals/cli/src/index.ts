...
// Set up CLI metadata
program.name("mux-eval").description("CLI tool for orchestrating MUX evaluations across multiple benchmarks").version("0.1.0")
...
program
	...
	.option("-k, --api-key <apiKey>", "MUX API key to use for evaluations")
	.action(async (options) => {
		try {
